    ...
    <div class="table-box">
      ...
      >
        ...
        <template #tableHeader>
          <el-button type="primary" @click="handleSubmit"> 报备订单（新增） </el-button>
        </template>
        <!-- 菜单操作 -->
...
const getTableList = (params: any) => {
  ...
  return getMyOrderList(newParams);
};
...
const handleSubmit = async () => {
  ...
  roleDrawer.value.acceptParams({
    ...
    row: {
      ...
      original_amount_unit: pointsData.original_amount_unit,
      original_amount_unit_desc: pointsData.original_amount_unit_desc,
