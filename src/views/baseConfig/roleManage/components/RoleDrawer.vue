  ...
  <el-drawer v-model="drawerVisible" :destroy-on-close="true" size="600px" :title="`${drawerProps.title}`">
    ...
    >
      <el-form-item label="角色名称" prop="name">
        <el-input v-model="drawerProps.row!.name" placeholder="请填写角色名称" clearable />
      </el-form-item>
      <el-form-item label="角色标识" prop="key">
        <el-input v-model="drawerProps.row!.key" placeholder="请填写角色标识" clearable />
      </el-form-item>
...
const rules = reactive({
  ...
  key: [{ required: true, message: "请填写角色标识" }],
